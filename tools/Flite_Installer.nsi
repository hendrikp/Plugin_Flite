...
; The file to write
OutFile "Plugin_Flite_${VERSION}.exe"
...
; Sections
Section "Flite" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\Flite"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\Flite\Plugin_Flite.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\Flite\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\Flite"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\Flite\Plugin_Flite.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\Flite\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_Flite"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_Flite\inc"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_Flite\changelog.md"'
FunctionEnd
